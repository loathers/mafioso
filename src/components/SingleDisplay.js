...
export default function SingleDisplay(props) {
  ...
  return (
    <div 
      style={style}
      className={combineClassnames('mar-2 pad-v-2 pad-h-3 overflow-hidden bg-second-darker borradius-2 flex-row aitems-center flexwrap-yes position-relative', className)}>
