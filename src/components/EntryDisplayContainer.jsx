...
import CombatSequenceDisplay, {CombatResultDisplayHandler} from './CombatSequenceDisplay';
        ...
        { isShowRightColumn &&
          <div className='borradius-r-2 bg-second flex-row pad-2 flex-none'>
            <Button
              ...
              <img src={TalkSVG} style={{width: 20, height: 20, opacity: 0.5}} className='mar-t-3' />
            </Button>
