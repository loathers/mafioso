...
export default observer(function LogVisualizerPage() {
  ...
  useEffect(() => {
    ...
    if (
      ...
      navigate(`${LOG_VIS_URL}/${logStore.hashcode}`);
    }
  ...
  return (
    <div id="app-page-visualizer" className="flex-row jcontent-center">
      <Helmet>
      ...
      <div id="app-content" className="flex-col-center flex-auto">
