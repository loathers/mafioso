export const LATTE_EFFECTS_MAP = {
  ...
  '+25 Sleaze Damage (grobold)': /(Grobold rum and|grobold rum|with a shot of grobold rum)/im,
  ...
  '+25% Combat Initiative': /(Dyspepsi-flavored|Dyspepsi|with a shot of Dyspepsi syrup)/im,
  '+3 Familiar Experience Per Combat': /(Fortified|vitamin|enriched with vitamins)/im,
  ...
  '+50 Spooky Damage': /(Ancient exotic spiced|ancient\/spicy|with ancient spice)/im,
  ...
  'Muscle +10, Moxie +10, Mysticality +10': /(Space pumpkin and|space pumpkin|with space pumpkin juice)/im,
  'Muscle +20, Moxie +20, Mysticality +20': /(Paradise milk|paradise milk|with milk of paradise)/im,
  'Muscle +20%, Mysticality +20%, Moxie +20%': /(Belgian vanilla|Belgian vanilla|with a shot of Belgian vanilla)/im,
  'Muscle +30': /(Dwarf creamed|dwarf cream|with dwarf cream)/im,
  'Muscle +5, Moxie +5, Mysticality +5': /(Sandalwood-infused|sandalwood splinter|with sandalwood splinters)/im,
  ...
  '10-20 HP Regen': /(Extra-healthy|health potion|with a shot of healing elixir )/im,
  ...
  'Weapon Damage +50': /(Gunpowder|and gunpowder|with gunpowder extra poison)/im,
}
