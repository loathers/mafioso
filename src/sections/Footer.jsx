  ...
  return (
    <div
      ...
      <FooterLink href='https://elementten.com'>
        ...
        <img src={ShareSVG} className='adjacent-mar-l-2' style={{width: 16, height: 16, fill: '#696969'}}/>
      </FooterLink>

      <FooterLink href='https://github.com/aahvocado/KoL-Mafioso/'>
        <div className='adjacent-mar-l-2'>Source</div>
        <img src={GithubSVG} className='adjacent-mar-l-2' style={{width: 16, height: 16, fill: '#696969'}}/>
      </FooterLink>
